...
namespace MalbersAnimations
{
    public class MFreeLookCamera : MonoBehaviour
    {
        ...
        public float m_MoveSpeed = 5f;                             // How fast the rig will move to keep up with the target's position.
        [Range(0f, 10f)]
        public float m_TurnSpeed = 5f;                             // How fast the rig will rotate from user input.
        public float m_TurnSmoothing = 5f;                         // How much smoothing to apply to the turn input, to reduce mouse-turn jerkiness
